...
export default function Home() {
    return (
        <>
            ...
            <div className={"w-full lg:px-40 md:px-20 px-10 md:py-10 py-5 tracking-widest"}>
                ...
                <div className={"lg:text-xl md:text-lg leading-loose space-y-8 pt-5"}>
                    ...
                    <p>
                        Our weekly general team meeting times are on Sundays at 3pm EST in the Wilson Center. The Business sub team also has additional meetings on Sundays in the Ross School of Business from 11:00am-12:00pm EST.
                    </p>
                    <p>
